              ...
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    // INNER JOIN pelanggan ON penjualan.idpelanggan = pelanggan.idpelanggan INNER JOIN barang ON detailpenjualan.idbarang = barang.idbarang WHERE penjualan.id_penjualan = '$id'" ) or die(mysqli_error($conn));
                    ...
                    INNER JOIN supplier ON pembelian.id_supplier = supplier.id_supplier WHERE pembelian.id_pembelian = '$id'") or die(mysqli_error($conn));
